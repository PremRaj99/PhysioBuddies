...
export default function RecommendCard({
  ...
  return (
    <div className="w-96 border border-gray-300 rounded-lg shadow-lg duration-150 bg-[#f9f7f777] m-1 hover:cursor-pointer hover:scale-[1.01]" onClick={navigate}>
      <img
        src={img}
        alt="card img"
      ...
      <div className="p-2">
        ...
        <div className="underline text-xs pt-2 font-semibold">
          Book Now
        </div>
      </div>
    </div>
